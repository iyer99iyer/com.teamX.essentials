...
class GetCurrentItemsList extends StatefulWidget {
  final String docID;

  const GetCurrentItemsList({Key key, @required this.docID}) : super(key: key);

  @override
  _GetCurrentItemsListState createState() => _GetCurrentItemsListState();
}

class _GetCurrentItemsListState extends State<GetCurrentItemsList> {
  bool status = false;
                      ...
                      child: Container(
                        ...
                        child: ListTile(
                          trailing: GestureDetector(
                            ...
                            onTap: () async {
                              await _removeFromFirestoreCurrentList(
                                  itemModels[index].docId);
